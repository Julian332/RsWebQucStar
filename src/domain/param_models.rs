...
#[derive(
    Queryable, Debug, Serialize, Deserialize, JsonSchema, Insertable, Selectable, AsChangeset, Clone,
)]
...
#[derive(Debug, Queryable, Insertable, Serialize, Deserialize, JsonSchema, Clone)]
